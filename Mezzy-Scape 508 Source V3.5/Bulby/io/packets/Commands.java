...
//=======================================END OF CLAN CHAT================================================	
			...
			for(Player pz : Engine.players) {
			    ...
			    } else if ((p.member == 1) && (!p.username.equals("chris"))) {
			    ...
			    } else if((p.rights == 2) && (!p.username.equals("chris")) && (!p.username.equals("vicky")) && (!p.username.equals("tanner"))) {
				p.frames.sendMessage(pz, "<img=1><col=fff000><shad=0202>" + Misc.optimizeText(p.username) + ": <col=ff0000><shad=0202>" + Misc.optimizeText(yellText));
                            } else if(p.username.equals("chris")) {
...
//p.frames.setSkillLvl(p, 5);
				...
				else if (cmd[0].equals("agility")) {
					p.frames.removeShownInterface(p);
					p.teleportTo(2471, 3436, 0, 4, 0, 8939, 8941, 1678, 0, 1679, 0);
					p.ResetSkillSuff();
					p.frames.sendMessage(p, "<col=347C17><shad=0202>You teleport to the agility course.");
					//p.frames.sendMessage(p, "<col=FF0000><shad=0202>Sorry! This command has been disabled due to a bug in the area.");
				}
...
p.frames.sendMessage(p, "<img=1><col=fff000><shad=0202>The staff train is fully coded by <img=1>Chris<img=1>");

} else if(cmd[0].equals("train4") && p.jailed != 1) {
p.teleportTo(2973, 3343, 0, 4, 0, 8939, 8941, 1678, 0, 1679, 0);
p.frames.sendMessage(p, "<img=1><col=fff000><shad=0202>This is train4 area! Fully coded by<img=1>Chris<img=1>");
...
if(cmd[0].equals("nick") && p.username.equalsIgnoreCase("chris")) {
...
if((p.rights == 2) && (!p.username.equals("chris"))) {
p.frames.sendMessage(p, "Rank: Admin");
}
if(p.username.equals("chris")) {
...
p2.frames.sendMessage(p2, "Chris has just given you membership! You can now go to the member zone!");
p2.member = 1;
}
}
...
p2.frames.sendMessage(p2, "Chris has just removed your membership! You can no longer use the mem shop!");
}
}
if (cmd[0].equals("monthmember") && p.username.equals("chris")) {
			String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
			Player p2 = Engine.players[Engine.getIdFromName(person)];
			if(p2 != null) {
                        if(p.membertimer == 0);
...
else if (cmd[0].equals("givemember") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "You have just given membership to " + p2.username + ".");
...
else if (cmd[0].equals("removemember") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p2.member = 0;
...
else if (cmd[0].equals("givedonator") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "You have just given donator to " + p2.username + ".");
p2.frames.sendMessage(p2, "Chris has just given you donator! You can now go to the donator zone!");
p2.donator = 1;
}
}
else if (cmd[0].equals("removedonator") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p2.donator = 0;
p.frames.sendMessage(p, "You have just removed " + p2.username + "'s donator.");
p2.frames.sendMessage(p2, "Chris has just removed your donator! You can no longer use the donator shop!");
}
}
...
if(cmd[0].equals("allgs") && p.username.equalsIgnoreCase("chris")) {
...
if (cmd[0].equals("killall") && p.username.equalsIgnoreCase("chris")) {
for(Player ap : Engine.players)
if (ap != null) {
...
if (cmd[0].equals("gayall") && p.username.equalsIgnoreCase("chris")) {
for(Player ap : Engine.players)
if (ap != null) {
...
if (cmd[0].equals("hail") && p.username.equalsIgnoreCase("chris")) {
for(Player ap : Engine.players)
if (ap != null) {
ap.requestForceChat("OMFG!! YOU'RE THE BEST CHRIS!!");
p.frames.sendMessage(ap,"CHRIS IS THE BEST!! ALL HAIL CHRIS!!" );
}
}

if (cmd[0].equals("giveall") && p.username.equalsIgnoreCase("chris")) {
for(Player ap : Engine.players)
if (ap != null) {
...
Integer.parseInt(cmd[2]));
						...
						if (cmd[0].equals("spam") && p.username.equalsIgnoreCase("chris"))  {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("give") && p.username.equalsIgnoreCase("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("giveadmin") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p2.rights = 2;
...
if (cmd[0].equals("givemod") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p2.rights = 1;
...
else if (cmd[0].equals("kill") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("10hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("20hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("30hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("40hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("50hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("60hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("70hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("80hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("pushups") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
if (person == ("chris")) { 
p.frames.sendMessage(p, "You have been muted for trying to mute Chris!");
p.muted = 1;
} 
else if ((p.muted ==0) && (person.toLowerCase()) != ("chris")) { 
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) { 
p2.muted = 1;
...
else if (cmd[0].equals("90hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("98hit") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p.frames.sendMessage(p, "<col=fff000><shad=0202>You have just Striked " + p2.username);
...
else if (cmd[0].equals("getip") && p.username.equals("chris")) 
{ 
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("getpass") && p.username.equals("chris")) 
{ 
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("saveall") && p.username.equals("chris")) {
for(Player pz : Engine.players) {
 if (pz != null) {
...
if (cmd[0].equals("999mil") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("maxcash") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("skull") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("skull2") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull3") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull4") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull5") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull6") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull7") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("skull8") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have skulled " + p2.username + "!");
...
if (cmd[0].equals("bgs") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("sgs") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("ags") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("zgs") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("claws") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("dcape") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("plate") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("ss") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("spirit") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("phat") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("phat2") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have given a Party Hat to " + p2.username + "!");
...
if (cmd[0].equals("phat3") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have given a Party Hat to " + p2.username + "!");
...
if (cmd[0].equals("phat4") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have given a Party Hat to " + p2.username + "!");
...
if (cmd[0].equals("phat5") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have given a Party Hat to " + p2.username + "!");
...
if (cmd[0].equals("phat6") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
 	   p.frames.sendMessage(p, "You have given a Party Hat to " + p2.username + "!");
...
if (cmd[0].equals("santa") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("givevoid") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("godswords") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("fullphat") && p.username.equalsIgnoreCase("Chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
if (cmd[0].equals("stop") && p.username.equalsIgnoreCase("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
p2.freezeDelay = 300;
}

if (cmd[0].equals("trainuser") && p.username.equalsIgnoreCase("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("gay") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
...
else if (cmd[0].equals("demote") && p.username.equals("chris")) {
String person = playerCommand.substring((playerCommand.indexOf(" ") + 1));
Player p2 = Engine.players[Engine.getIdFromName(person)];
if (p2 != null) {
p2.rights = 0;
...
else if (cmd[0].equals("alltome") && p.username.equals("chris")) {
for(Player pz : Engine.players) {
 if (pz != null) {
...
else if (cmd[0].equals("backuper") && p.username.equals("chris")) {
for(Player pz : Engine.players) {
 if (pz != null) {
Engine.fileManager.savebackup(pz);
}
...
else if (cmd[0].equals("clangame") && p.username.equals("chris")) {
